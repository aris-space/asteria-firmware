...
workspaces := "fw-engine-board fw-sensor-carrier fw-sensor-carrier-v3 fw-backplane fw-fuel-control-board fw-oxidizer-control-board fw-lox-valve-control-board fw-recovery-board fw-test-board crates tools"
