...
macro_rules! define_signal {
    (
        $channels:ident, $watches:ident, $submit:ident, $watch_getter:ident :
        $T:ty, $id_ty:ty,
...
define_signal!(
    IMU_CHANNELS, IMU_WATCHES, submit_imu_sample, imu_watch:
    ImuSample, ImuId,
...
define_signal!(
    PRESSURE_CHANNELS, PRESSURE_WATCHES, submit_pressure_sample, pressure_watch:
